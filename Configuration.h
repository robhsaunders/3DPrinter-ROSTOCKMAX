...
#if MOTHERBOARD==301
#define MOTOR_CURRENT {150,150,150,130,0} // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)  use 140 for xyz and 160 for the E if using Kysan motors and 175 xyz and 200 if using wantai motors
#elif MOTHERBOARD==12
